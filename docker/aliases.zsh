...
alias vaquero='docker run --rm -it -v $(pwd):$(pwd) -w $(pwd) shippedrepos-docker-vaquero.bintray.io/vaquero/vaquero``'
...
alias geronimo='docker run -ti --rm -v $PWD:/configs registry.vipertv.net/viper/geronimo:2.0'
